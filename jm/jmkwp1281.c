...
static size_t _jm_kwp1281_pack(JMKWP1281 *self, const guint8 *src, 
...
static size_t _jm_kwp1281_unpack(JMKWP1281 *self, const guint8 *src, 
    size_t count, guint8 *tar)
{
    g_return_val_if_fail(self != NULL, 0);
...
size_t jm_kwp1281_pack(JMKWP1281 *self, const guint8 *src, size_t count, 
    guint8 *tar)
{
    g_return_val_if_fail(self != NULL, 0);
...
size_t jm_kwp1281_unpack(JMKWP1281 *self, const guint8 *src, size_t count, 
    guint8 *tar)
{
    g_return_val_if_fail(self != NULL, 0);
...
gint32 jm_kwp1281_set_lines(JMKWP1281 *self, gint32 com_line, 
    gboolean l_line)
{
    g_return_val_if_fail(self != NULL, JM_ERROR_GENERIC);
