...
static size_t _jm_mikuni_pack(JMMikuni *self, const guint8 *src, size_t count, guint8 *tar) {
...
static size_t _jm_mikuni_unpack(JMMikuni *self, const guint8 *src, size_t count, guint8 *tar) {
    g_return_val_if_fail(self != NULL, 0);
