...
JNIEXPORT jobject Java_jm_ui_GUI_nativePopMsg(JNIEnv *env, jclass cls)
{
    ...
    id_GUIMessage = (*env)->GetMethodID(env, class_GUIMessage, "<init>", "(ILjava/lang/String;)V");
    obj_GUIMessage = (*env)->NewObject(env, class_GUIMessage, id_GUIMessage, msg->type, (*env)->NewStringUTF(env, msg->message));
    jm_ui_msg_free(msg);
