...
#define  SENDIDLENGTH  sizeof (SENDCMDOUTPARAMS) + IDENTIFY_BUFFER_SIZE
    ...
    public:
        ...
        guint64 driveSize(size_t drive)
        {
    ...
    private:
        ...
        gchar* flipAndCodeBytes(const gchar* str)
        {
        ...
        gchar* ConvertToString(WORD diskdata [256], int firstIndex, 
            int lastIndex)
        {
...
IDE_ATAPI_IDENTIFY : IDE_ATA_IDENTIFY;
    ...
    private:
        gchar HardDriveSerialNumber[1024];
        GPtrArray *m_list;
    };
}
