...
static size_t _jm_v1_comm_send_and_recv(JMComm *self, const guint8 *send, size_t count, guint8 *recv) {
    guint32 times = 3;
    g_return_val_if_fail(self != NULL, 0);
...
static gint32 _jm_v1_comm_set_timeout(JMComm *self, gint32 tx_b2b, gint32 rx_b2b, gint32 tx_f2f, gint32 rx_f2f, gint32 total) {
