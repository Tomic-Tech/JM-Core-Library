...
static gboolean _jm_v1_box_c168_send_ok(JMV1Box *self, gint64 microseconds)
{
    ...
    while (TRUE)
    {
        ...
        else if (receive_buffer >= JM_V1_BOX_C168_UP_TIMEOUT && 
            receive_buffer <= JM_V1_BOX_C168_ERROR_REC)
        {
...
static size_t _jm_v1_box_c168_buffer_size(JMV1Box *self)
{
    ...
    return c168->buff_add[JM_V1_BOX_C168_LINKBLOCK] - 
        c168->buff_add[JM_V1_BOX_C168_SWAPBLOCK];
}

static gboolean _jm_v1_box_c168_commbox_do(JMV1Box *self, 
    guint8 command_word, size_t count, const guint8 *buff);

static gboolean _jm_v1_box_c168_send_data_to_ecu_new(JMV1Box *self, 
    size_t count, const guint8 *buff)
{
    ...
    command[checksum] = JM_V1_BOX_C168_WR_DATA + command[1] + command[2] + 
        command[3] + command[4];
    ...
    for (i = 0; i < 3; i++)
    {
        if (!_jm_v1_box_c168_check_idle(self) || 
...
static gboolean _jm_v1_box_c168_send_data_to_ecu_old(JMV1Box *self, 
    size_t count, const guint8 *buff)
{
    size_t i;
...
static gboolean _jm_v1_box_c168_send_data_to_ecu(JMV1Box *self, 
    guint8 command_word, size_t count, const guint8 *buff)
{
    JMV1BoxC168 *c168 = (JMV1BoxC168*)self->user_data;
    if (command_word == JM_V1_BOX_C168_SEND_DATA && 
        count <= JM_V1_BOX_C168_SEND_LEN)
    {
        ...
        return _jm_v1_box_c168_commbox_do(self, JM_V1_BOX_C168_D0_BAT, 1, 
            c168->buff_add + JM_V1_BOX_C168_SWAPBLOCK);
    }
...
static gboolean _jm_v1_box_c168_commbox_command(JMV1Box *self, 
    guint8 command_word, size_t count, const guint8 *buff)
{
    size_t size = count + 2;
    ...
    for (i = 0; i < 3; i++)
    {
        if (command_word != JM_V1_BOX_C168_STOP_REC && 
            command_word != JM_V1_BOX_C168_STOP_EXECUTE)
        {
            if (!_jm_v1_box_c168_check_idle(self) || 
                (jm_commbox_port_write(command, size) != size))
            {
    ...
    guint8 command_word, size_t count, const guint8 *buff)
{
    ...
    {
        return _jm_v1_box_c168_send_data_to_ecu(self, command_word, count, 
            buff);
    }
    else
    {
        return _jm_v1_box_c168_commbox_command(self, command_word, count, 
            buff);
    }
}

static gboolean _jm_v1_box_c168_check_result(JMV1Box *self, 
    gint64 microseconds)
{
...
static gboolean _jm_v1_box_c168_stop_now(JMV1Box *self, 
    gboolean is_stop_execute)
{
    ...
    if (is_stop_execute)
    {
        ...
        while (times--)
        {
            if (!_jm_v1_box_c168_commbox_do(self, 
                JM_V1_BOX_C168_STOP_EXECUTE, 0, NULL))
            {
                return FALSE;
            }
            if (jm_commbox_port_read(&receive_buffer, 1) != 1)
    ...
    return _jm_v1_box_c168_commbox_do(self, JM_V1_BOX_C168_STOP_REC, 0, 
        NULL);
}

static gboolean _jm_v1_box_c168_do_set(JMV1Box *self, guint8 command_word, 
    size_t count, const guint8 *buff)
{
    guint32 times = JM_V1_BOX_C168_REPLAYTIMES;
    g_return_val_if_fail(self != NULL, FALSE);
...
static size_t _jm_v1_box_c168_read_data(JMV1Box *self, guint8 *buff, 
...
static size_t _jm_v1_box_c168_get_cmd_data(JMV1Box *self, guint8 command, 
    guint8 *receive_buffer)
{
    ...
    if (_jm_v1_box_c168_read_data(self, cmd_info, 2, 
        JM_TIMER_TO_MS(150)) != 2)
    {
        return 0;
    }
    ...
    if ((_jm_v1_box_c168_read_data(self, receive_buffer, cmd_info[1], 
        JM_TIMER_TO_MS(150)) != cmd_info[1]) ||
        (_jm_v1_box_c168_read_data(self, cmd_info, 1, JM_TIMER_TO_MS(150)) 
        != 1))
    {
        return 0;
    }
...
static gboolean _jm_v1_box_c168_check_box(JMV1Box *self)
{
    ...
    if (_jm_v1_box_c168_get_cmd_data(self, JM_V1_BOX_C168_GETINFO, temp) 
        <= 0)
    {
        return FALSE;
    }
...
static gboolean _jm_v1_box_c168_init_box(JMV1Box *self)
{
    ...
    length = _jm_v1_box_c168_get_cmd_data(self, JM_V1_BOX_C168_GETINFO, 
        c168->cmd_temp);
    ...
    memset(c168->buff_add, JM_V1_BOX_C168_NULLADD, 
        JM_V1_BOX_C168_MAXIM_BLOCK);
    c168->buff_add[JM_V1_BOX_C168_LINKBLOCK] = c168->cmd_buff_len;
    c168->buff_add[JM_V1_BOX_C168_SWAPBLOCK] = 0;
    return TRUE;
}

static gboolean _jm_v1_box_c168_set_rf(JMV1Box *self, guint8 cmd, 
    guint8 cmd_info)
{
    ...
    {
        if (_jm_v1_box_c168_check_idle(self) && 
            (jm_commbox_port_write(&cmd_info, 1) == 1))
        {
...
static gboolean _jm_v1_box_c168_serial_port_change_config(JMV1Box *self)
{
    ...
    if (!_jm_v1_box_c168_commbox_do(self, JM_V1_BOX_C168_SET_UPBAUD, 1, 
        &baud))
    {
        return FALSE;
    }
    ...
    _jm_v1_box_c168_set_rf(self, JM_V1_BOX_C168_SETRFBAUD, 
        JM_V1_BOX_C168_UP_57600BPS);
    _jm_v1_box_c168_check_result(self, JM_TIMER_TO_MS(50));
    c168->serial_port_baud = 57600;
    return TRUE;
}

static gboolean _jm_v1_box_c168_check_serial_port_change_config(
    JMV1Box *self)
{
    guint8 baud = JM_V1_BOX_C168_UP_57600BPS;
    g_return_val_if_fail(self != NULL, FALSE);
...
static gboolean _jm_v1_box_c168_del_batch(JMV1Box *self, guint8 buff_id)
{
    ...
    else
    {
        ...
        if (i < c168->buff_used_num - 1)
        {
            ...
            if (!_jm_v1_box_c168_do_set(self, JM_V1_BOX_C168_COPY_DATA - 
                JM_V1_BOX_C168_COPY_DATA % 4, 3, data))
            {
                return FALSE;
            }
        }
        ...
        for (i = i + 1; i < c168->buff_used_num; i++)
        {
            ...
            c168->buff_add[c168->buff_used[i]] = 
                c168->buff_add[c168->buff_used[i]] - delete_buff_len;
        }
        c168->buff_used_num--;
        c168->buff_add[JM_V1_BOX_C168_SWAPBLOCK] = 
            c168->buff_add[JM_V1_BOX_C168_SWAPBLOCK] - delete_buff_len;
...
static gboolean _jm_v1_box_c168_new_batch(JMV1Box *self, guint8 buff_id)
{
    ...
    if ((c168->buff_add[buff_id] != JM_V1_BOX_C168_NULLADD && 
        (buff_id != JM_V1_BOX_C168_LINKBLOCK) && 
        !_jm_v1_box_c168_del_batch(self, buff_id)))
    {
        return FALSE;;
    }
...
static gboolean _jm_v1_box_c168_add_to_buff(JMV1Box *self, 
    guint8 command_word, size_t count, const guint8 *data)
{
    size_t i;
    guint8 checksum;
    JMV1BoxC168 *c168 = NULL;
    ...
    if (command_word < JM_V1_BOX_C168_RESET && 
        command_word != JM_V1_BOX_C168_CLR_LINK &&
        command_word != JM_V1_BOX_C168_DO_BAT_00 && 
        command_word != JM_V1_BOX_C168_D0_BAT &&
        command_word != JM_V1_BOX_C168_D0_BAT_FOR && 
        command_word != JM_V1_BOX_C168_WR_DATA)
    {
        // 是否为缓冲区命令?
        if ((count < JM_V1_BOX_C168_CMD_DATALEN) ||
            (command_word == JM_V1_BOX_C168_SEND_DATA && 
            count < JM_V1_BOX_C168_SEND_LEN))
        {
            // 是否合法命令?
            if (command_word == JM_V1_BOX_C168_SEND_DATA && 
                _jm_v1_box_c168_get_box_ver(self) > 0x400)
            {
                // 增加发送长命令
                c168->cmd_temp[c168->cmd_temp[1] + 2] = 
                    JM_V1_BOX_C168_SEND_CMD;
                checksum += JM_V1_BOX_C168_SEND_CMD;
                c168->cmd_temp[1]++;
                c168->cmd_temp[c168->cmd_temp[1] + 2] = command_word + 
                    count;
                if (count > 0)
                {
                    c168->cmd_temp[c168->cmd_temp[1] + 2]--;
                ...
                c168->cmd_temp[c168->cmd_temp[1] + 2] = checksum + count + 
                    2;
...
static gboolean _jm_v1_box_c168_end_batch(JMV1Box *self)
{
    ...
    while (times--)
    {
        ...
        if (!_jm_v1_box_c168_check_idle(self) || 
            (jm_commbox_port_write(c168->cmd_temp, c168->cmd_temp[1] + 3) 
            != (c168->cmd_temp[1] + 3)))
        {
            continue;
        }
        else if (_jm_v1_box_c168_send_ok(self, 
            JM_TIMER_TO_MS(20) * (c168->cmd_temp[1] + 10)))
        {
            break;
        }
    ...
    {
        c168->buff_add[JM_V1_BOX_C168_LINKBLOCK] = 
            c168->cmd_buff_len - c168->cmd_temp[1];
    }
    else
    {
        c168->buff_add[c168->buff_id] = 
            c168->buff_add[JM_V1_BOX_C168_SWAPBLOCK];
        c168->buff_used[c168->buff_used_num] = c168->buff_id;
        c168->buff_used_num++;
        c168->buff_add[JM_V1_BOX_C168_SWAPBLOCK] = 
            c168->buff_add[JM_V1_BOX_C168_SWAPBLOCK] + c168->cmd_temp[1];
    }
    c168->buff_id = JM_V1_BOX_C168_NULLADD;
    return TRUE;
}

static gboolean _jm_v1_box_c168_send_to_box(JMV1Box *self, 
    guint8 command_word, size_t count, const guint8 *buff)
{
    g_return_val_if_fail(self != NULL, FALSE);
...
static gboolean _jm_v1_box_c168_set_line_level(JMV1Box *self, 
    guint8 value_low, guint8 value_high)
{
    ...
    return _jm_v1_box_c168_send_to_box(self, JM_V1_BOX_C168_SETPORT1, 1, 
        c168->port + 1);
}

static gboolean _jm_v1_box_c168_set_comm_ctrl(JMV1Box *self, 
    guint8 value_open, guint8 value_close)
{
    ...
    return _jm_v1_box_c168_send_to_box(self, JM_V1_BOX_C168_SETPORT2, 1, 
        c168->port + 2);
}

static gboolean _jm_v1_box_c168_set_comm_line(JMV1Box *self, 
    guint8 send_line, guint8 recv_line)
{
    ...
    return _jm_v1_box_c168_send_to_box(self, JM_V1_BOX_C168_SETPORT0, 1, 
        c168->port);
}
...
{
    // 将原有的接受一个发送一个的标志翻转
    return _jm_v1_box_c168_send_to_box(self, JM_V1_BOX_C168_SET_ONEBYONE, 
        0, NULL);
}

static gboolean _jm_v1_box_c168_set_echo_data(JMV1Box *self, 
    guint8 *echo_buff, size_t echo_len)
{
    g_return_val_if_fail(self != NULL, FALSE);
    ...
    if (self->shared->is_do_now)
    {
        ...
        size_t i;
        if (!_jm_v1_box_c168_commbox_do(self, JM_V1_BOX_C168_ECHO, 
            echo_len, echo_buff) || 
            (_jm_v1_box_c168_read_data(self, receive_buff, echo_len, 
            JM_TIMER_TO_MS(100)) != echo_len))
        {
            return FALSE;
        }
    ...
    return _jm_v1_box_c168_add_to_buff(self, JM_V1_BOX_C168_ECHO, echo_len,
        echo_buff);
}

static gboolean _jm_v1_box_c168_keep_link(JMV1Box *self, 
    gboolean is_run_link)
{
    if (is_run_link)
    {
        return _jm_v1_box_c168_send_to_box(self, JM_V1_BOX_C168_RUNLINK, 0, 
            NULL);
    }
    return _jm_v1_box_c168_send_to_box(self, JM_V1_BOX_C168_STOPLINK, 0, 
        NULL);
}

static gboolean _jm_v1_box_c168_set_comm_link(JMV1Box *self, 
    guint8 ctrl_word1, guint8 ctrl_word2, guint8 ctrl_word3)
{
    ...
    if (mode_control == JM_V1_BOX_C168_SET_VPW || 
        mode_control == JM_V1_BOX_C168_SET_PWM)
    {
        return _jm_v1_box_c168_send_to_box(self, JM_V1_BOX_C168_SETTING, 1, 
            ctrl_word);
    }
    ...
    return _jm_v1_box_c168_send_to_box(self, JM_V1_BOX_C168_SETTING, 
        length, ctrl_word);
}
...
static gboolean _jm_v1_box_c168_set_comm_baud(JMV1Box *self, gdouble baud)
{
    ...
    if (baud_time[0] == 0)
    {
        return _jm_v1_box_c168_send_to_box(self, JM_V1_BOX_C168_SETBAUD, 1, 
            baud_time + 1);
    }
    else
    {
        return _jm_v1_box_c168_send_to_box(self, JM_V1_BOX_C168_SETBAUD, 2,
            baud_time);
    }
}

static void _jm_v1_box_c168_get_link_time(JMV1Box *self, guint8 type, 
    guint32 time)
{
...
static gboolean _jm_v1_box_c168_set_comm_time(JMV1Box *self, guint8 type, 
    guint32 time)
{
    guint8 time_buff[2];
    JMV1BoxC168 *c168 = NULL;
    ...
    if (type == JM_V1_BOX_C168_SETVPWSTART || 
        type == JM_V1_BOX_C168_SETVPWRECS)
    {
        ...
        || type == JM_V1_BOX_C168_SETLINKTIME)
    {
        ...
        if (time_buff[0] == 0)
        {
            return _jm_v1_box_c168_send_to_box(self, type, 1, 
                time_buff + 1);
        }
...
static gboolean _jm_v1_box_c168_run_receive(JMV1Box *self, guint8 type)
{
    ...
    if (type == JM_V1_BOX_C168_GET_PORT1 || 
        type == JM_V1_BOX_C168_SET55_BAUD || 
...
static guint8 _jm_v1_box_c168_get_abs_add(JMV1Box *self, guint8 buff_id, 
    guint8 add)
{
    size_t length = 0;
    guint8 start_add = 0;
    ...
    if (c168->buff_id != buff_id)
    {
        ...
        else
        {
            ...
            if (i == (c168->buff_used_num - 1))
            {
                length = c168->buff_add[JM_V1_BOX_C168_SWAPBLOCK] - 
                    c168->buff_add[buff_id];
            }
            else
            {
                length = c168->buff_add[buff_id + 1] - 
                    c168->buff_add[buff_id];
            }
        }
    ...
    {
        length = c168->buff_add[JM_V1_BOX_C168_LINKBLOCK] - 
            c168->buff_add[JM_V1_BOX_C168_SWAPBLOCK];
...
static gboolean _jm_v1_box_c168_update_buff(JMV1Box *self, guint8 type, 
    guint8 *buffer)
{
    guint8 cmd_temp[4];
    guint8 ret;
    ...
    if ((type == JM_V1_BOX_C168_INVERT_DATA) || 
        (type == JM_V1_BOX_C168_DEC_DATA) || 
        (type == JM_V1_BOX_C168_INC_DATA))
    {
    }
    else if ((type == JM_V1_BOX_C168_UPDATE_1BYTE) || 
        (type == JM_V1_BOX_C168_SUB_BYTE))
    {
        cmd_temp[1] = buffer[2];
    }
    ...
    else if ((type == JM_V1_BOX_C168_COPY_DATA) || 
        (type == JM_V1_BOX_C168_ADD_1BYTE))
    {
        ret = _jm_v1_box_c168_get_abs_add(self, buffer[2], buffer[3]);
        if (ret == 0)
        {
    ...
    else if ((type == JM_V1_BOX_C168_UPDATE_2BYTE) || 
        (type == JM_V1_BOX_C168_ADD_2BYTE))
    {
    ...
    else if ((type == JM_V1_BOX_C168_ADD_DATA) || 
        (type == JM_V1_BOX_C168_SUB_DATA))
    {
        ret = _jm_v1_box_c168_get_abs_add(self, buffer[2], buffer[3]);
        if (ret == 0)
        {
    ...
    return _jm_v1_box_c168_send_to_box(self, type - type % 4, type % 4 + 1, 
        cmd_temp);
}
...
static gboolean _jm_v1_box_c168_commbox_delay(JMV1Box *self, guint32 time)
{
    ...
    if (time_buff[0] == 0)
    {
        if (self->shared->is_do_now)
        {
            return _jm_v1_box_c168_commbox_do(self, delay_word, 1, 
                time_buff + 1);
        }
        return _jm_v1_box_c168_add_to_buff(self, delay_word, 1, 
            time_buff + 1);
    }
    if (self->shared->is_do_now)
    {
...
static gboolean _jm_v1_box_c168_send_out_data(JMV1Box *self, 
    const guint8 *buffer, size_t count)
{
    ...
    if (self->shared->is_do_now)
    {
        return _jm_v1_box_c168_commbox_do(self, JM_V1_BOX_C168_SEND_DATA, 
            count, buffer);
    }
    else
    {
        return _jm_v1_box_c168_add_to_buff(self, JM_V1_BOX_C168_SEND_DATA, 
            count, buffer);
    }
}

static gboolean _jm_v1_box_c168_run_batch(JMV1Box *self, guint8 *buff_id, 
    size_t count, gboolean is_execute_many)
{
    ...
    if (command_word == JM_V1_BOX_C168_D0_BAT && 
        buff_id[0] == c168->buff_used[0])
    {
        command_word = JM_V1_BOX_C168_DO_BAT_00;
...
static size_t _jm_v1_box_c168_read_bytes(JMV1Box *self, guint8 *buff, 
    size_t count)
{
    g_return_val_if_fail(self != NULL, FALSE);
    return _jm_v1_box_c168_read_data(self, buff, count, 
        self->shared->res_wait_time);
}
...
JMV1Box* jm_v1_box_c168_new(JMV1Shared *shared)
{
    ...
    obj->check_serial_port_change_config = 
        _jm_v1_box_c168_check_serial_port_change_config;
