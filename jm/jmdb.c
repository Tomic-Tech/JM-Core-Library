...
static const gchar* _jm_db_live_data_query = "SELECT ShortName, Content, Unit, DefaultValue, CommandID, AlgorithmID FROM live_data WHERE Catalog=:catalog AND Language=:language";
