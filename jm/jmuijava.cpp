...
JNIEXPORT jobject Java_jm_ui_GUI_nativePopMsg(JNIEnv *env, jclass cls)
{
    ...
    class_GUIMessage = env->FindClass("jm/gui/Message");
    id_GUIMessage = env->GetMethodID(class_GUIMessage, "<init>", "(ILjava/lang/String;)V");
    obj_GUIMessage = env->NewObject(class_GUIMessage, id_GUIMessage, msg->type, env->NewStringUTF(msg->message));
    jm_ui_msg_free(msg);
